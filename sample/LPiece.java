...
public class LPiece extends Piece{
    ...
    public LPiece(int x, int y){
        ...
        this.squares[3] = new Rectangle(x+(2*GameBoard.BLOCKSIZE),y+(2*GameBoard.BLOCKSIZE),GameBoard.RENDERSIZE,GameBoard.RENDERSIZE);
        for(int i = 0; i<4;i++) {
            this.squares[i].setFill(Color.PEACHPUFF);
        }
    }
    @Override
    public void rotate(){
